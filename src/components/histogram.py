...
layout = dbc.Container([
    ...
    # ============= AJOUT: Dropdown pour filtrer par sexe =============
    dcc.Dropdown(
...
@callback(
    ...
    # ============= AJOUT: Input pour le filtre sexe =============
    Input("sex-dropdown-hist", "value")
    # ============= FIN AJOUT =============
)
def update_histogram(selected_year, selected_sex):  # ============= AJOUT: Paramètre selected_sex =============
    """
    ...
    Args:
        ...
        selected_sex: The sex filter selected by the user  # ============= AJOUT =============
