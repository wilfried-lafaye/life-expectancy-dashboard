...
- **Python 3.11 or 3.12 (This project currently has compatibility issues with Python 3.14 due to deprecated functions used by Dash; please use Python 3.12 or 3.11 instead.)**
